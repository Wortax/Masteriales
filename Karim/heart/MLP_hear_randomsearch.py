...
class MLPModel(nn.Module):
    def __init__(self, input_size, hidden_layer1, hidden_layer2, dropout1, dropout2):
...
class TorchModel(BaseEstimator, ClassifierMixin):
    def __init__(self, input_size, hidden_layer1=128, hidden_layer2=64, dropout1=0.3, dropout2=0.2, learning_rate=0.001, weight_decay=1e-4, epochs=10):
    ...
    def fit(self, X, y):
        ...
        self.model = MLPModel(self.input_size, self.hidden_layer1, self.hidden_layer2, self.dropout1, self.dropout2).to(device)
...
model = TorchModel(input_size=X_train.shape[1])
